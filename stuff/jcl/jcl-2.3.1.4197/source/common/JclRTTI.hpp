...
__interface  INTERFACE_UUID("{84E57A52-7219-4248-BDC7-4AACBFE2002D}") IJclBaseInfo  : public IInterface 
{
...
public:
	virtual AnsiString __fastcall SaveValueToString(System::TObject* AnObj, const AnsiString PropName) = 0 ;
	virtual void __fastcall LoadValueFromString(System::TObject* AnObj, const AnsiString PropName, const AnsiString Value) = 0 ;
};
...
public:
	virtual void __fastcall WriteTo(const _di_IJclInfoWriter Dest);
	AnsiString __fastcall SaveValueToString(System::TObject* AnObj, const AnsiString PropName);
	void __fastcall LoadValueFromString(System::TObject* AnObj, const AnsiString PropName, const AnsiString Value);
...
public:
	virtual void __fastcall WriteTo(const _di_IJclInfoWriter Dest);
	virtual void __fastcall DeclarationTo(const _di_IJclInfoWriter Dest);
	HIDESBASE AnsiString __fastcall SaveValueToString(System::TObject* AnObj, const AnsiString PropName);
	HIDESBASE void __fastcall LoadValueFromString(System::TObject* AnObj, const AnsiString PropName, const AnsiString Value);
...
public:
	...
	virtual AnsiString __fastcall SaveValueToString(System::TObject* AnObj) = 0 ;
	virtual void __fastcall LoadValueFromString(System::TObject* AnObj, const AnsiString Value) = 0 ;
...
public:
	...
	AnsiString __fastcall SaveValueToString(System::TObject* AnObj);
	void __fastcall LoadValueFromString(System::TObject* AnObj, const AnsiString Value);
	__property Typinfo::PPropInfo PropInfo = {read=GetPropInfo};
	__property _di_IJclTypeInfo PropType = {read=GetPropType};
	__property void * Reader = {read=GetReader};
	__property void * Writer = {read=GetWriter};
...
public:
	virtual AnsiString __fastcall GetAbsoluteName(void) = 0 ;
	virtual System::TObject* __fastcall GetInstance(void) = 0 ;
	HIDESBASE virtual bool __fastcall IsStored(void) = 0 /* overload */;
	HIDESBASE virtual AnsiString __fastcall SaveValueToString(void) = 0 ;
	HIDESBASE virtual void __fastcall LoadValueFromString(const AnsiString Value) = 0 ;
	__property AnsiString AbsoluteName = {read=GetAbsoluteName};
...
public:
	__fastcall TJclObjPropInfo(const Typinfo::PPropInfo APropInfo, const AnsiString APrefix, System::TObject* AInstance);
	AnsiString __fastcall GetAbsoluteName();
	System::TObject* __fastcall GetInstance(void);
	HIDESBASE bool __fastcall IsStored(void)/* overload */;
	HIDESBASE AnsiString __fastcall SaveValueToString()/* overload */;
	HIDESBASE void __fastcall LoadValueFromString(const AnsiString Value)/* overload */;
public:
	#pragma option push -w-inl
...
private:
	void *__IJclObjPropInfo;	/* Jclrtti::IJclObjPropInfo */
...
public:
	...
	virtual _di_IJclObjPropInfo __fastcall GetObjPropNames(const AnsiString Name) = 0 ;
	HIDESBASE virtual AnsiString __fastcall SaveValueToString(const AnsiString PropName) = 0 /* overload */;
	HIDESBASE virtual void __fastcall LoadValueFromString(const AnsiString PropName, const AnsiString Value) = 0 /* overload */;
	__property System::TObject* Instance = {read=GetInstance};
	__property _di_IJclObjPropInfo ObjProperties[int PropIdx] = {read=GetObjProperties};
	__property _di_IJclObjPropInfo ObjPropNames[AnsiString Name] = {read=GetObjPropNames};
};
...
public:
	__fastcall TJclObjClassTypeInfo(const Typinfo::PTypeInfo ATypeInfo, const AnsiString APrefix, System::TObject* AInstance);
	System::TObject* __fastcall GetInstance(void);
	_di_IJclObjPropInfo __fastcall GetObjProperties(const int PropIdx);
	_di_IJclObjPropInfo __fastcall GetObjPropNames(const AnsiString Name);
	HIDESBASE AnsiString __fastcall SaveValueToString(const AnsiString PropName)/* overload */;
	HIDESBASE void __fastcall LoadValueFromString(const AnsiString PropName, const AnsiString Value)/* overload */;
public:
	#pragma option push -w-inl
...
private:
	void *__IJclObjClassTypeInfo;	/* Jclrtti::IJclObjClassTypeInfo */
