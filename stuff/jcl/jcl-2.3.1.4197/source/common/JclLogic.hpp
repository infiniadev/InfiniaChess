...
extern PACKAGE __int64 __fastcall LRot(const __int64 Value, const Byte Count)/* overload */;
extern PACKAGE __int64 __fastcall RRot(const __int64 Value, const Byte Count)/* overload */;
