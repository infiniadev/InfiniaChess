...
typedef void __fastcall (*TAnsiStrIterateProcedure)(const AnsiString AString);

typedef void __fastcall (*TWideStrIterateProcedure)(const WideString AString);

typedef void __fastcall (*TStrIterateProcedure)(const AnsiString AString);
...
typedef void __fastcall (*TExtendedIterateProcedure)(const Extended AValue);

typedef void __fastcall (*TFloatIterateProcedure)(const Extended AValue);
...
__interface  INTERFACE_UUID("{1064D0B4-D9FC-475D-88BE-520490013B46}") IJclAbstractIterator  : public IInterface 
{
...
__interface  INTERFACE_UUID("{C517175A-028E-486A-BF27-5EF7FC3101D9}") IJclBaseContainer  : public IInterface 
{
...
__interface  INTERFACE_UUID("{17C1D3FB-BB32-48F2-BD1C-D43EA05A86A8}") IJclIntfOwner  : public IInterface 
{
...
typedef AnsiString __fastcall (__closure *TFreeAnsiStrEvent)(AnsiString &AString);

__interface IJclAnsiStrOwner;
typedef System::DelphiInterface<IJclAnsiStrOwner> _di_IJclAnsiStrOwner;
__interface  INTERFACE_UUID("{4F64F1F6-766A-4CFA-B51B-654116E308A8}") IJclAnsiStrOwner  : public IInterface 
{
	
public:
	virtual TFreeAnsiStrEvent __fastcall GetOnFreeString(void) = 0 ;
	virtual AnsiString __fastcall FreeString(AnsiString &AString) = 0 ;
...
typedef WideString __fastcall (__closure *TFreeWideStrEvent)(WideString &AString);

__interface IJclWideStrOwner;
typedef System::DelphiInterface<IJclWideStrOwner> _di_IJclWideStrOwner;
__interface  INTERFACE_UUID("{282B7A64-BCD0-4EAE-8776-4EF92D7E3D8B}") IJclWideStrOwner  : public IInterface 
{
	
public:
	virtual TFreeWideStrEvent __fastcall GetOnFreeString(void) = 0 ;
	virtual WideString __fastcall FreeString(WideString &AString) = 0 ;
...
typedef AnsiString __fastcall (__closure *TFreeStrEvent)(AnsiString &AString);

typedef IJclAnsiStrOwner IJclStrOwner;
;
...
__interface  INTERFACE_UUID("{B002C201-70D7-4FA8-B44A-6D18E82580E5}") IJclSingleOwner  : public IInterface 
{
...
__interface  INTERFACE_UUID("{3BEFEDB0-C904-4400-ABEF-40FC928BB258}") IJclDoubleOwner  : public IInterface 
{
...
typedef Extended __fastcall (__closure *TFreeExtendedEvent)(Extended &AValue);

__interface IJclExtendedOwner;
typedef System::DelphiInterface<IJclExtendedOwner> _di_IJclExtendedOwner;
__interface  INTERFACE_UUID("{4501B203-6784-479D-8A8E-FBE3E1249CCF}") IJclExtendedOwner  : public IInterface 
{
	
public:
	virtual TFreeExtendedEvent __fastcall GetOnFreeExtended(void) = 0 ;
	virtual Extended __fastcall FreeExtended(Extended &AValue) = 0 ;
...
typedef Extended __fastcall (__closure *TFreeFloatEvent)(Extended &AValue);

typedef IJclExtendedOwner IJclFloatOwner;
;
...
__interface  INTERFACE_UUID("{00E37ECB-0FF0-4833-8143-EB7FBEF9E208}") IJclIntegerOwner  : public IInterface 
{
...
__interface  INTERFACE_UUID("{27B3EDEF-0ACD-4592-95F2-52A1DF5E7A39}") IJclCardinalOwner  : public IInterface 
{
...
__interface  INTERFACE_UUID("{7D4A1375-057A-42B8-8DAA-52DE30058864}") IJclInt64Owner  : public IInterface 
{
...
__interface  INTERFACE_UUID("{28340328-34AD-4632-9BAC-A7387A822200}") IJclPtrOwner  : public IInterface 
{
...
typedef void __fastcall (*TFloatSortProc)(const _di_IJclExtendedList AList, int L, int R, TExtendedCompare AComparator);
