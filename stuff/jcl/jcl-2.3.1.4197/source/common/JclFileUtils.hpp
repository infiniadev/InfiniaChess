...
__interface  INTERFACE_UUID("{B73D9E3D-34C5-4DA9-88EF-4CA730328FC9}") IJclFileSearchOptions  : public IInterface 
{
...
private:
	void *__IJclFileSearchOptions;	/* Jclfileutils::IJclFileSearchOptions */
...
typedef DynamicArray<TLangIdRec >  JclFileUtils__8;
...
public:
	...
	/*         class method */ static bool __fastcall FileHasVersionInfo(TMetaClass* vmt, const AnsiString FileName);
...
typedef DynamicArray<AnsiString >  JclFileUtils__91;

typedef DynamicArray<Byte >  JclFileUtils__02;
...
extern PACKAGE bool __fastcall PathIsEqualOrChild(const AnsiString Path, const AnsiString Base);
...
extern PACKAGE bool __fastcall BuildFileList(const AnsiString Path, const int Attr, const Classes::TStrings* List, bool IncludeDirectoryName = false);
...
extern PACKAGE bool __fastcall VersionResourceAvailable(const AnsiString FileName)/* overload */;
...
extern PACKAGE AnsiString __fastcall WindowToModuleFileName(const HWND Window);
