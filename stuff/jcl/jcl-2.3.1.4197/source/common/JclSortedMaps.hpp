...
typedef TJclAnsiStrIntfSortedEntry  TJclStrIntfSortedEntry;

typedef TJclAnsiStrIntfSortedMap TJclStrIntfSortedMap;
;

typedef TJclIntfAnsiStrSortedEntry  TJclIntfStrSortedEntry;

typedef TJclIntfAnsiStrSortedMap TJclIntfStrSortedMap;
;

typedef TJclAnsiStrAnsiStrSortedEntry  TJclStrStrSortedEntry;
...
typedef TJclAnsiStrSortedEntry  TJclStrSortedEntry;
