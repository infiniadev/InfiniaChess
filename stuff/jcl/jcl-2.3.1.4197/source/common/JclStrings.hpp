...
extern PACKAGE void __fastcall StrSkipChars(char * &S, const TCharValidator Chars)/* overload */;
extern PACKAGE void __fastcall StrSkipChars(char * &S, char const * Chars, const int Chars_Size)/* overload */;
extern PACKAGE void __fastcall StrSkipChars(const AnsiString S, int &Index, const TCharValidator Chars)/* overload */;
extern PACKAGE void __fastcall StrSkipChars(const AnsiString S, int &Index, char const * Chars, const int Chars_Size)/* overload */;
...
extern PACKAGE bool __fastcall StrHasSuffix(const AnsiString S, AnsiString const * Suffixes, const int Suffixes_Size);
...
extern PACKAGE bool __fastcall StrIHasSuffix(const AnsiString S, AnsiString const * Suffixes, const int Suffixes_Size);
...
extern PACKAGE int __fastcall StrISuffixIndex(const AnsiString S, AnsiString const * Suffixes, const int Suffixes_Size);
...
extern PACKAGE int __fastcall StrSuffixIndex(const AnsiString S, AnsiString const * Suffixes, const int Suffixes_Size);
...
extern PACKAGE AnsiString __fastcall StringsToStr(const Classes::TStrings* List, const AnsiString Sep, const bool AllowEmptyString = true)/* overload */;
extern PACKAGE AnsiString __fastcall StringsToStr(const Classes::TStrings* List, const AnsiString Sep, const int NumberOfItems, const bool AllowEmptyString = true)/* overload */;
...
extern PACKAGE bool __fastcall StrIdent(const AnsiString S, int &Index, /* out */ AnsiString &Ident)/* overload */;
extern PACKAGE bool __fastcall StrIdent(char * &S, /* out */ AnsiString &Ident)/* overload */;
