...
extern PACKAGE int __fastcall AnsiStrSimpleCompareI(const AnsiString Obj1, const AnsiString Obj2);
extern PACKAGE int __fastcall WideStrSimpleCompare(const WideString Obj1, const WideString Obj2);
extern PACKAGE int __fastcall WideStrSimpleCompareI(const WideString Obj1, const WideString Obj2);
...
extern PACKAGE bool __fastcall AnsiStrSimpleEqualityCompareI(const AnsiString Obj1, const AnsiString Obj2);
extern PACKAGE bool __fastcall WideStrSimpleEqualityCompare(const WideString Obj1, const WideString Obj2);
extern PACKAGE bool __fastcall WideStrSimpleEqualityCompareI(const WideString Obj1, const WideString Obj2);
...
extern PACKAGE int __fastcall AnsiStrSimpleHashConvert(const AnsiString AString);
extern PACKAGE int __fastcall AnsiStrSimpleHashConvertI(const AnsiString AString);
extern PACKAGE int __fastcall AnsiStrSimpleHashConvertU(const AnsiString AString);
extern PACKAGE int __fastcall AnsiStrSimpleHashConvertUI(const AnsiString AString);
extern PACKAGE int __fastcall WideStrSimpleHashConvert(const WideString AString);
extern PACKAGE int __fastcall WideStrSimpleHashConvertI(const WideString AString);
extern PACKAGE int __fastcall StrSimpleHashConvert(const AnsiString AString);
...
extern PACKAGE int __fastcall ExtendedSimpleHashConvert(const Extended AValue);
extern PACKAGE int __fastcall FloatSimpleHashConvert(const Extended AValue);
