...
extern PACKAGE int __fastcall UTF8GetNextBuffer(const AnsiString S, int &StrPos, Jclbase::TUCS4Array &Buffer, int &Start, int Count);
...
extern PACKAGE int __fastcall UTF8SetNextBuffer(AnsiString &S, int &StrPos, const Jclbase::TUCS4Array Buffer, int &Start, int Count);
...
extern PACKAGE int __fastcall UTF16GetNextBuffer(const WideString S, int &StrPos, Jclbase::TUCS4Array &Buffer, int &Start, int Count)/* overload */;
...
extern PACKAGE int __fastcall UTF16SetNextBuffer(WideString &S, int &StrPos, const Jclbase::TUCS4Array Buffer, int &Start, int Count)/* overload */;
...
extern PACKAGE int __fastcall AnsiGetNextBuffer(const AnsiString S, int &StrPos, Jclbase::TUCS4Array &Buffer, int &Start, int Count)/* overload */;
...
extern PACKAGE int __fastcall AnsiGetNextBuffer(const AnsiString S, Word CodePage, int &StrPos, Jclbase::TUCS4Array &Buffer, int &Start, int Count)/* overload */;
extern PACKAGE bool __fastcall AnsiGetNextCharFromStream(Classes::TStream* S, Word CodePage, /* out */ unsigned &Ch)/* overload */;
extern PACKAGE int __fastcall AnsiGetNextBufferFromStream(Classes::TStream* S, Word CodePage, Jclbase::TUCS4Array &Buffer, int &Start, int Count)/* overload */;
...
extern PACKAGE int __fastcall AnsiSetNextBuffer(AnsiString &S, int &StrPos, const Jclbase::TUCS4Array Buffer, int &Start, int Count)/* overload */;
...
extern PACKAGE int __fastcall AnsiSetNextBuffer(AnsiString &S, Word CodePage, int &StrPos, const Jclbase::TUCS4Array Buffer, int &Start, int Count)/* overload */;
extern PACKAGE bool __fastcall AnsiSetNextCharToStream(Classes::TStream* S, Word CodePage, unsigned Ch)/* overload */;
extern PACKAGE int __fastcall AnsiSetNextBufferToStream(Classes::TStream* S, Word CodePage, const Jclbase::TUCS4Array Buffer, int &Start, int Count)/* overload */;
extern PACKAGE unsigned __fastcall StringGetNextChar(const AnsiString S, int &StrPos);
extern PACKAGE int __fastcall StringGetNextBuffer(const AnsiString S, int &StrPos, Jclbase::TUCS4Array &Buffer, int &Start, int Count);
...
extern PACKAGE int __fastcall StringSetNextBuffer(AnsiString &S, int &StrPos, const Jclbase::TUCS4Array Buffer, int &Start, int Count);
