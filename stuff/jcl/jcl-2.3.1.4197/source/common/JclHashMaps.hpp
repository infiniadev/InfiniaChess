...
typedef TJclAnsiStrIntfHashEntry  TJclStrIntfHashEntry;

typedef TJclAnsiStrIntfBucket TJclStrIntfBucket;
;

typedef TJclAnsiStrIntfHashMap TJclStrIntfHashMap;
;

typedef TJclIntfAnsiStrHashEntry  TJclIntfStrHashEntry;

typedef TJclIntfAnsiStrBucket TJclIntfStrBucket;
;

typedef TJclIntfAnsiStrHashMap TJclIntfStrHashMap;
;

typedef TJclAnsiStrAnsiStrHashEntry  TJclStrStrHashEntry;

typedef TJclAnsiStrAnsiStrBucket TJclStrStrBucket;
;
...
typedef TJclAnsiStrHashEntry  TJclStrHashEntry;

typedef TJclAnsiStrBucket TJclStrBucket;
;
