...
extern PACKAGE void __fastcall StrSkipChars(const AnsiString S, int &Index, const Sysutils::TSysCharSet &Chars)/* overload */;
...
extern PACKAGE AnsiString __fastcall StrTrimQuotes(const AnsiString S)/* overload */;
extern PACKAGE AnsiString __fastcall StrTrimQuotes(const AnsiString S, char QuoteChar)/* overload */;
