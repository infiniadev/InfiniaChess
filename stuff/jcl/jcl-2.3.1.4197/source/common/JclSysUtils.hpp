...
private:
	Byte __fastcall GetCurrencyDecimals(void);
	Byte __fastcall GetCurrencyFormat(void);
	AnsiString __fastcall GetCurrencyString();
	char __fastcall GetDateSeparator(void);
	int __fastcall GetDayNamesHighIndex(void);
	int __fastcall GetDayNamesLowIndex(void);
	char __fastcall GetDecimalSeparator(void);
	char __fastcall GetListSeparator(void);
	AnsiString __fastcall GetLongDateFormat();
	AnsiString __fastcall GetLongDayNames(int AIndex);
	AnsiString __fastcall GetLongMonthNames(int AIndex);
	AnsiString __fastcall GetLongTimeFormat();
	int __fastcall GetMonthNamesHighIndex(void);
	int __fastcall GetMonthNamesLowIndex(void);
	Byte __fastcall GetNegCurrFormat(void);
	AnsiString __fastcall GetShortDateFormat();
	AnsiString __fastcall GetShortDayNames(int AIndex);
	AnsiString __fastcall GetShortMonthNames(int AIndex);
	AnsiString __fastcall GetShortTimeFormat();
	char __fastcall GetThousandSeparator(void);
	AnsiString __fastcall GetTimeAMString();
	AnsiString __fastcall GetTimePMString();
	char __fastcall GetTimeSeparator(void);
	Word __fastcall GetTwoDigitYearCenturyWindow(void);
	void __fastcall SetCurrencyDecimals(Byte AValue);
	void __fastcall SetCurrencyFormat(const Byte AValue);
	void __fastcall SetCurrencyString(AnsiString AValue);
	void __fastcall SetDateSeparator(const char AValue);
	void __fastcall SetDecimalSeparator(char AValue);
	void __fastcall SetListSeparator(const char AValue);
	void __fastcall SetLongDateFormat(const AnsiString AValue);
	void __fastcall SetLongTimeFormat(const AnsiString AValue);
	void __fastcall SetNegCurrFormat(const Byte AValue);
	void __fastcall SetShortDateFormat(AnsiString AValue);
	void __fastcall SetShortTimeFormat(const AnsiString AValue);
	void __fastcall SetThousandSeparator(char AValue);
	void __fastcall SetTimeAMString(const AnsiString AValue);
	void __fastcall SetTimePMString(const AnsiString AValue);
	void __fastcall SetTimeSeparator(const char AValue);
	void __fastcall SetTwoDigitYearCenturyWindow(const Word AValue);
	
public:
	__property Byte CurrencyDecimals = {read=GetCurrencyDecimals, write=SetCurrencyDecimals, nodefault};
	__property Byte CurrencyFormat = {read=GetCurrencyFormat, write=SetCurrencyFormat, nodefault};
	__property AnsiString CurrencyString = {read=GetCurrencyString, write=SetCurrencyString};
	__property char DateSeparator = {read=GetDateSeparator, write=SetDateSeparator, nodefault};
	...
	__property char DecimalSeparator = {read=GetDecimalSeparator, write=SetDecimalSeparator, nodefault};
	__property char ListSeparator = {read=GetListSeparator, write=SetListSeparator, nodefault};
	__property AnsiString LongDateFormat = {read=GetLongDateFormat, write=SetLongDateFormat};
	__property AnsiString LongDayNames[int AIndex] = {read=GetLongDayNames};
	__property AnsiString LongMonthNames[int AIndex] = {read=GetLongMonthNames};
	__property AnsiString LongTimeFormat = {read=GetLongTimeFormat, write=SetLongTimeFormat};
	...
	__property Byte NegCurrFormat = {read=GetNegCurrFormat, write=SetNegCurrFormat, nodefault};
	__property AnsiString ShortDateFormat = {read=GetShortDateFormat, write=SetShortDateFormat};
	__property AnsiString ShortDayNames[int AIndex] = {read=GetShortDayNames};
	__property AnsiString ShortMonthNames[int AIndex] = {read=GetShortMonthNames};
	__property AnsiString ShortTimeFormat = {read=GetShortTimeFormat, write=SetShortTimeFormat};
	__property char ThousandSeparator = {read=GetThousandSeparator, write=SetThousandSeparator, nodefault};
	__property AnsiString TimeAMString = {read=GetTimeAMString, write=SetTimeAMString};
	__property AnsiString TimePMString = {read=GetTimePMString, write=SetTimePMString};
	__property char TimeSeparator = {read=GetTimeSeparator, write=SetTimeSeparator, nodefault};
	__property Word TwoDigitYearCenturyWindow = {read=GetTwoDigitYearCenturyWindow, write=SetTwoDigitYearCenturyWindow, nodefault};
public:
	#pragma option push -w-inl
...
extern PACKAGE unsigned __fastcall Execute(const AnsiString CommandLine, Jclsynch::TJclEvent* AbortEvent, AnsiString &Output, bool RawOutput = false)/* overload */;
...
extern PACKAGE unsigned __fastcall Execute(const AnsiString CommandLine, Jclsynch::TJclEvent* AbortEvent, TTextHandler OutputLineCallback, bool RawOutput = false)/* overload */;
extern PACKAGE unsigned __fastcall Execute(const AnsiString CommandLine, AnsiString &Output, AnsiString &Error, bool RawOutput = false, bool RawError = false, System::PBoolean AbortPtr = (void *)(0x0))/* overload */;
extern PACKAGE unsigned __fastcall Execute(const AnsiString CommandLine, Jclsynch::TJclEvent* AbortEvent, AnsiString &Output, AnsiString &Error, bool RawOutput = false, bool RawError = false)/* overload */;
extern PACKAGE unsigned __fastcall Execute(const AnsiString CommandLine, TTextHandler OutputLineCallback, TTextHandler ErrorLineCallback, bool RawOutput = false, bool RawError = false, System::PBoolean AbortPtr = (void *)(0x0))/* overload */;
extern PACKAGE unsigned __fastcall Execute(const AnsiString CommandLine, Jclsynch::TJclEvent* AbortEvent, TTextHandler OutputLineCallback, TTextHandler ErrorLineCallback, bool RawOutput = false, bool RawError = false)/* overload */;
...
extern PACKAGE bool __fastcall VarIsNullEmpty(const Variant &V);
extern PACKAGE bool __fastcall VarIsNullEmptyBlank(const Variant &V);
