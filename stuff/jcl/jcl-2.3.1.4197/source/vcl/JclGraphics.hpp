...
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, AnsiString ControlToPrint)/* overload */;
...
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, Forms::TCustomForm* FormToPrint, AnsiString ControlToPrint)/* overload */;
