...
extern PACKAGE AnsiString __fastcall PeMapImgLibraryName32(const void * BaseAddress);
extern PACKAGE AnsiString __fastcall PeMapImgLibraryName64(const void * BaseAddress);
...
extern PACKAGE int __fastcall PeMapImgFindSection(const TImageSectionHeaderArray ImageSectionHeaders, const AnsiString SectionName);
