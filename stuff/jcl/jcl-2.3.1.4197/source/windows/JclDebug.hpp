...
public:
	...
	/*         class method */ static AnsiString __fastcall MapStringCacheToFileName(TMetaClass* vmt, TJclMapStringCache &MapString);
	/*         class method */ static AnsiString __fastcall MapStringCacheToModuleName(TMetaClass* vmt, TJclMapStringCache &MapString);
	/*         class method */ static AnsiString __fastcall MapStringCacheToStr(TMetaClass* vmt, TJclMapStringCache &MapString, bool IgnoreSpaces = false);
...
extern PACKAGE AnsiString __fastcall ProcByLevel(const int Level = 0x0, bool OnlyProcedureName = false);
...
extern PACKAGE void __fastcall AddModule(const AnsiString ModuleName);
