...
Source: "D:\work\Chess\installshields\!files\infiniachess.dat"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\work\Chess\installshields\!files\infiniachess.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{userdesktop}\ChessClient"; Filename: "{app}\chclient.exe"; Tasks: desktopicon
...
[Run]
Filename: "{app}\infiniachess.exe"; Description: "{cm:LaunchProgram,InfiniaChess}"; Flags: nowait postinstall skipifsilent
